...
function EmailOTP() {
    ...
    const verifyEmailOTP = async () => {
        try {
            ...
            const response = await axios.post(`${url}/verifyEmail`, {id: id}, {
    ...
    return (
        ...
        <div className= 'w-1/4 mx-auto mt-3 flex flex-col justify-center items-center'>
          ...
          <div className= 'content w-full '> 
                    <h2 className='text-xl font-semibold '>Enter OTP to verify Your Email</h2>
          ...
          src="https://authenticator.2stable.com/assets/img/press-kit/AppIcon/app-icon-1024-square.png"
           ...
           width="150px"
            /> 
                    ...
                    <p className='text-sm mt-4'> You need to verify the your email address to proceed KYC verification. Please verify your email by entering the OTP sent in your email</p>
