                            ...
                            return (
                                <>
                                    <tr key={index} className={index % 2 == 0 ? 'bg-slate-50' : 'bg-slate-100'}>
                                        ...
                                        <td className="border border-slate-300 px-3 text-left">{singleUser.firstName + ' ' + singleUser.lastName}</td>
                                        <td className="border border-slate-300  text-left px-3">{singleUser.email}</td>
                                        <td className="border border-slate-300  ">{moment.utc(singleUser.createdOn).format('MM/DD/YYYY')}</td>
                                        <td className="border border-slate-300">unverified</td>
                                        <td className="border border-slate-300 align-left " >
                                            <button className="border bg-green-500 text-white text-sm px-4 mt-1 py-2 mb-2 rounded :hover-bg-green-700">Verify</button>
                                            <button className="border ml-2 bg-red-600 text-white text-sm px-4 mt-1 mb-2 py-2 rounded :hover-bg-green-700" onClick={() => deleteUser(singleUser._id)}>Delete</button>
                                        </td>
                                    </tr>
                                </>
                            )
