...
function ForgotPasswordEmail() {
  ...
  return (
    <div>
        <h1 className='text-2xl font-bold mt-5 mx-auto center'>Please enter your email address to recover password</h1>
                    <Formik
                            initialValues={{
                                email: "",
                            }}
                        ...
                        >
                            {({ errors, touched, isValidating }) => (
                                        ...
                                        <Field type='text' className="w-full border border-gray-300 h-8 p-2 focus:outline-indigo-400" placeholder='email' name='email' validate={validateEmail} />
