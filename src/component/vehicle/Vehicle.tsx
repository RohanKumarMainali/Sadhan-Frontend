                ...
                return (<>
                    <div className=' bg-white w-9/12 mx-auto mt-4 flex flex-col h-auto'>
                        ...
                        <div className='header float-left'>
                            <h1 className='text-2xl text-left p-2 font-semibold'>{item.name + ' ' + item.model}</h1>

                        </div>

                        <div className='body h-4/5 flex justify-between'>
                            <div className='image w-8/12 h-3/4 bg-green-200 rounded-sm drop-shadow-sm bg-rounded'
                                style={{
                                ...
                                <div className='content date '>
                                    ...
                                    <div className='date-container flex flex-col gap-y-4 mt-2'>
                                        <div className='date-input flex justify-between w-2/3 mx-auto'>
                                            <label className='texl-sm'>Start Date</label><input name='startDate' type='date' className='bg-white-100 rounded-sm shadow'></input>
                                        </div>
                                        <div className='date-input flex justify-between w-2/3 mx-auto'>
                                            <label className='texl-sm'>End Date</label><input name='endDate' type='date' className='bg-white-100 rounded-sm shadow'></input>
                                        </div>
                                        <div className='total flex w-2/3 gap-y-4 mx-auto flex-col align-left'>
                                            <h1 className='text-left'>Price {' ' + item.price + '/day'}</h1>
                                            <span className='text-left'>Total 5 Days</span>
                                            <span className='text-left'>Total Price = Rs 8000</span>
                                        </div>
                                        <button className='w-2/3 bg-indigo-500 text-white mx-auto py-2 px-1 shadow-sm rounded-sm text-xl font-semibold' >Book Now! </button>
                                    </div>
                                </div>
                            </div>
