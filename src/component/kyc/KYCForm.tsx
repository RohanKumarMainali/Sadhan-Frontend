...
const KYCForm = ()=> {
    ...
    const id = JSON.parse(user).id
     ...
     const postKyc = async(values : formType)=>{
                  
            var form : any= new FormData();
            form.append("firstName", values.firstName)
            form.append("citizenshipImageFront", values.citizenshipImageFront)
            form.append("citizenshipImageBack", values.citizenshipImageBack)
            form.append("drivingLicenseImage", values.drivingLicenseImage)
            form.append('id', id)
            console.log(form)
            try {
                       ...
                       <div className="flex justify-between">
                          ...
                          <div className="flex flex-col w-1/6">
                            ...
                            <input
                              ...
                              onChange = {(e:any)=>{setFieldValue("citizenshipImageFront",e.target.files[0])}} 
                            />

                            {values.citizenshipImageFront && <PreviewImage file={values.citizenshipImageFront}/> }
                          </div>
                           ...
                           <div className="flex flex-col w-1/6">
                            ...
                            <input
                              ...
                              onChange = {(e:any)=>{setFieldValue("citizenshipImageBack",e.target.files[0])}} 
                            />

                            {values.citizenshipImageBack && <PreviewImage file={values.citizenshipImageBack}/> }
                          </div>
                       ...
                       <div className="flex justify-between">
                          ...
                          <div className="flex flex-col w-1/6">
                            ...
                            <input
                              ...
                              onChange = {(e:any)=>{setFieldValue("drivingLicenseImage",e.target.files[0])}} 
                            />

                            {values.drivingLicenseImage && <PreviewImage file={values.drivingLicenseImage}/> }
                          </div>
                         <div className="flex flex-col w-1/6">
